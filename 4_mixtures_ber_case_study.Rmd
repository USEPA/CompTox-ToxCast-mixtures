...
p1 <- ggplot(pfas_demo_plot, aes(x=demographic,y=factor(chem_name,unique(chem_name)),size=ber,fill=value))+
  geom_point(shape=21)+
  scale_size(range=c(3,12),name="Median BER: ",breaks=c(6E2,1E3,5E3,19.5E3))+ #132
  ...
  theme(axis.text.x = element_text(angle=50,hjust=1,vjust=1.0,size=14, color="black"),
        ...
        plot.margin=margin(t=30,r=20,b=0,l=20))+
...
```{r}
# tiff("ber_bubbleplot_aeid102_134.tiff", units="in", width=20, height=10, res=800)
# plot_grid(p1,p2,labels='AUTO',label_size=28) #c('A','B'),label_size=32
# dev.off()
```
...
p1 <- ggplot(pfas_demo_plot, aes(x=demographic,y=factor(chem_name,unique(chem_name)),size=exposure,fill=value))+
  geom_point(shape=21)+
  scale_size(range=c(3,12),name="Median Exposure: ",breaks=c(2.5E-3,1E-2,4.2E-2),labels = label_scientific())+ #132
  # scale_size(range=c(3,12),name="Median BER: ",breaks=c(7.5E2,1E3,5E3,17.5E3))+ #134
  # scale_size(range=c(3,12),name="Median BER: ",breaks=c(1.85E3,5E3,10E3,30.5E3))+ #102
  ...
  theme(axis.text.x = element_text(angle=50,hjust=1,vjust=1.0,size=14, color="black"),
        ...
        plot.margin=margin(t=30,r=10,b=0,l=20))+
  guides(size = guide_legend(order = 1),
         colorbar = guide_legend(order = 2))+
  scale_x_discrete(labels=c("Female"="Female","Male"="Male",
                            "Young"="Age < 20 Years", "Old"= expression("Age">="20 Years"),
...
tiff("exposure_bubbleplot_aeid132.tiff", units="in", width=12, height=10, res=800)
