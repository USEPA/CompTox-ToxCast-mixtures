...
p_mix <- ggplot_build(plotlines.func(index=ex_index,mix_input=mix.info,tc=FALSE) +
                      ...
                      theme(legend.title=element_blank(),
                            ...
                            axis.text = element_text(color="black"),
                            plot.margin = margin(t=0.3, r=0.3,b=0.3,l=0.8, unit = "cm"),
...
p_boot <- ggplot_build(plotint.func(index=ex_index,tc=FALSE) +
                      ...
                      theme(legend.title=element_blank(),
                            ...
                            legend.spacing.y = unit(-0.1, "mm"),
                            axis.text = element_text(color="black"),
                            plot.margin = margin(t=0.2, r=0.5,b=0.2,l=0.8, unit = "cm"),
...
annotate("segment",linewidth=1,x=0.21,y=0.78,xend=0.35,yend=0.73,arrow=arrow())+
annotate("segment",linewidth=1,x=0.21,y=0.17,xend=0.35,yend=0.23,arrow=arrow())
dev.off()
